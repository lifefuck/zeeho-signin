...
# ==================== 部署配置（按需修改）====================
HOST = "<YOUR_NAS_IP>"              # 飞牛 NAS IP
PORT = 22
USER = "<YOUR_SSH_USER>"            # SSH 用户名
PASS = "<YOUR_SSH_PASSWORD>"        # SSH 密码
QL_BASE = "http://<YOUR_NAS_IP>:5700"  # 青龙面板地址
QL_USER = "admin"
QL_PASS = "<YOUR_QL_PASSWORD>"      # 青龙登录密码
LOCAL_DIR = "<YOUR_LOCAL_SCRIPT_DIR>"  # 本地脚本目录（含 zeeho_signin.py 和 zeeho_data.json）
REMOTE_DIR = "/vol2/1000/docker/qinglong/data/scripts/zeeho"  # NAS 上青龙 scripts 目录
...
def main():
    ...
    for f in ["zeeho_signin.py", "zeeho_data.json"]:
